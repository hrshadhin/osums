  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Books<small> Borrow book update</small></h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            @if (isset($book))
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                        <input type="text" readonly=" "class="form-control" value="{{$bookInfo->code}}">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group ">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" readonly="true" value="{{$book->issueDate->format('d/m/Y')}}">
                      </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group ">
                      ...
                      <div class="input-group">
                        ...
                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i> </span>
                        <input type="text"   class="form-control datepicker" name="returnDate" required value="{{$book->returnDate->format('d/m/Y')}}" >
                      </div>
