          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Subject<small> Subject basic information.</small></h2>
                            ...
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              ...
                              <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  {!!Form::select('department_id', $departments, $subject->department_id, ['placeholder' => 'Pick a department','class'=>'form-control col-md-7 col-xs-12','required'=>'required'])!!}
                              ...
                              <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                   {!!Form::select('levelTerm', $semesters, $subject->levelTerm, ['placeholder' => 'Pick a Semester','class'=>'select2_single semester form-control col-md-7 col-xs-12','required'=>'required'])!!}
                              ...
                              <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input id="name" type="text" class="form-control col-md-7 col-xs-12"  name="name" value="{{$subject->name}}" placeholder="Biology" required="required" type="text">
                              ...
                              <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="credit" name="credit" required="required" placeholder="120" value="{{$subject->credit}}" class="form-control col-md-7 col-xs-12">
