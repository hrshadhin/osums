  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Dormitory<small> Lists</small></h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            @if (count($errors) > 0)
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                        <input type="number" class="form-control" required name="numOfRoom" value="{{$dormitory->numOfRoom}}">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                        <input type="number" class="form-control" required name="numOfRoom" placeholder="Total rooms in it">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
